...
class ListFragment : Fragment() {
    ...
    private fun setupListWithArrayAdapter() {
        val data = mutableListOf(
            Cat(UUID.randomUUID().toString(), "Troll"),
            Cat(UUID.randomUUID().toString(), "Trolia"),
            Cat(UUID.randomUUID().toString(), "Trolis"),
            Cat(UUID.randomUUID().toString(), "Trololos"),
        )
    ...
    private fun deleteCharecter(cat: Cat) {
        ...
        val dialog = AlertDialog.Builder(requireContext())
            .setTitle("Delete troll")
            .setMessage("Delete this troll ?")
